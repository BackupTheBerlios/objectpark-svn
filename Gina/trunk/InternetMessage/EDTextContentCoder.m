            ...
            else
            {
                ...
                else if([tag isEqualToString: @"/bold"])
                {
                    ...
                    attributeAndRange = [NSDictionary dictionaryWithObjectsAndKeys:
										 ...
										 [NSNumber numberWithInt:([rawString length] - [[marker objectAtIndex:1] intValue]) ], @"length",
                        nil, nil];
...
//                    OPDebugLog(EDTEXTCONTENTCONTROLLER, OPINFO, @"excerpt");
    ...
    text = [[NSMutableAttributedString alloc] initWithString:rawString attributes:[NSDictionary dictionaryWithObject:[[self class] defaultFont] forKey:NSFontAttributeName]];
