...
+ (NSString*) persistentAttributesPlist
{
	...
	@"groups = {AttributeClass = GIMessageGroup; QueryString =\"select Z_4THREADS.Z_4GROUPS from Z_4THREADS where Z_4THREADS.Z_6THREADS=?\"; ContainerClass=NSMutableArray; JoinTableName=Z_4THREADS; InverseRelationshipKey=threadsByDate; SourceKeyColumnName = Z_6THREADS; TargetKeyColumnName = Z_4GROUPS; };"
