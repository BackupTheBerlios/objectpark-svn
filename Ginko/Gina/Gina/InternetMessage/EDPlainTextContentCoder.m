...
- (void) _takeTextFromMessagePart: (EDMessagePart*) mpart
{
    ...
    {
        if (NSDebugEnabled) NSLog(@"cannot decode charset %@", charset);
        return;
    }
    [text retain];
...
- (NSAttributedString *)attributedString
{
    ...
    [result addAttribute:NSFontAttributeName value:[[self class] defaultFont] range:NSMakeRange(0, [result length])];
