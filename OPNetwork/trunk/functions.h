...
//  @(#)$Id: functions.h,v 1.2 2004/05/24 20:18:59 theisen Exp $
//
...
NSString *OPStringFromInAddr(struct in_addr address);
...
struct in_addr OPInAddrFromString(NSString *string);
