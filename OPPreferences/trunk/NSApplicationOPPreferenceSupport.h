//
//  NSApplication (OPPreferenceSupport)
//
...
@interface NSApplication (OPPreferenceSupport)


- (IBAction) openPreferences: (id) sender;

/* Application Hooks send to the delegate: */ 
//- (void) preferencePaneDidLoad: (OPPreferencePane*) pane;
